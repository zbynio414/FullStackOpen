const blogs = [
  ...
  //Define a function called mostBlogs that receives an array
// of blogs as a parameter. The function returns the author 
//who has the largest amount of blogs. 
//The return value also contains the number of blogs the top author has:
// Steps:
//1. Count by Author => _.conuntBy
// Math.max
//2. Find the Author with most Blogs => _.find()
let _ = require('lodash')
const blogCountByAuthor = _.countBy(blogs, 'author')
console.log(blogCountByAuthor)
const counterOnly = Object.values(blogCountByAuthor)
...
const bestBlogger = Object(blogCountByAuthor)[2]
